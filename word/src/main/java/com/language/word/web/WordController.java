...
public class WordController {
    ...
    public Results addWord(Long id,String name, String translate,  String pronunciation, Integer typeId,Integer showType, String synonym, String wordClasses, String shorthand, String phrases, String otherInfo){

        if(id != null){
            return busWordService.modifyWord(id,synonym,wordClasses,shorthand,phrases,otherInfo);
        }
        return busWordService.addWord(name,translate,pronunciation,typeId,showType,synonym,wordClasses,shorthand,phrases,otherInfo);
    }
}
